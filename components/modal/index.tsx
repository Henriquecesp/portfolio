    ...
    return (
        <ClientOnlyPortal selector="#modal">
            ...
            <div className="fixed z-50 left-0 top-0 w-full h-full">
                <div
                    className="relative top-1/2 -translate-y-1/2 mx-auto p-5 w-1/2 h-96 shadow-lg rounded-md bg-purple-500"
                    ref={modal}
                    style={{
                        width: '50vw',
                        height: '50vh'
                    ...
                    <div className="mt-3 text-center text-white">
                        ...
                        {title}
                        <div className="mt-2 px-7 py-3 text-white">{body}</div>
                        <div className="items-center px-4 py-3 text-white">{actions}</div>
                    </div>
                </div>
            </div>
        </ClientOnlyPortal>
